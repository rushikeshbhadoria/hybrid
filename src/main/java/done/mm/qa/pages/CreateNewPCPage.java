...
public class CreateNewPCPage extends TestBase {
	...
	public void CreatePC() throws Exception {
		...
		String path="C:\\Users\\Dell\\eclipse2-workspace\\SpqAdmin\\src\\main\\java\\done\\mm\\qa\\util\\23.08.2022_16.07.43_REC.png";
		sendKey(driver, mobileIcon, path, 5);
		sendKey(driver, webIcon, path, 5);
		Thread.sleep(2000);
		clickOn(driver, submit, 5);
		
		readMessege("Master account created successfully");
